...
import com.encryt.code.stream.ByteArrayOutputStream;
import com.encryt.code.stream.StringBuilderWriter;
...
public class IOUtils {
    ...
    public static InputStream toInputStream(String input, Charset encoding) {
        try {
			return new ByteArrayInputStream(input.getBytes(Charsets.toCharset(encoding).name()));
    ...
    public static InputStream toInputStream(String input, String encoding) throws IOException {
        byte[] bytes = input.getBytes(Charsets.toCharset(encoding).name());
    ...
    public static void write(byte[] data, Writer output, Charset encoding) throws IOException {
        if (data != null) {
            output.write(new String(data, encoding.name()));
//            output.write(new String(data, Charsets.toCharset(encoding)));
    ...
    public static void write(char[] data, OutputStream output, Charset encoding) throws IOException {
        if (data != null) {
            output.write(new String(data).getBytes(Charsets.toCharset(encoding).name()));
        }
    }
    ...
    public static void write(StringBuffer data, OutputStream output, String encoding) throws IOException {
        if (data != null) {
            output.write(data.toString().getBytes(Charsets.toCharset(encoding).name()));
        }
    }
